      ...
      <Row className="justify-content-center mb-5">
        <Col md={8} className="text-center">
          ...
          {!user ? (
            <div className="d-flex justify-content-center gap-3 mt-4">
              <Link to="/dangnhap">
                <Button
                  ...
                  size="lg"
                  className="btn-hover btn-hover-light"
                >
                  Đăng nhập
                </Button>
              </Link>
            ...
            <p className="fs-5 text-success mt-4">
              Chúc bạn một phiên đấu giá thành công!
            </p>
          )}
        </Col>
      </Row>
          ...
          <Card className="mb-4 shadow-lg effect-card">
            <Card.Body>
              ...
              >
                ...
                <Card.Text>
                  Theo dõi và tham gia các phiên đấu giá trực tiếp với nhiều sản
                  phẩm đặc sắc.
                </Card.Text>
              </Link>
            </Card.Body>
            ...
            <Card className="mb-4 shadow-lg effect-card">
              <Card.Body>
                ...
                >
                  ...
                  <Card.Text>
                    Đăng sản phẩm để đấu giá và quản lý trạng thái giao dịch.
                  </Card.Text>
                </Link>
              </Card.Body>
            </Card>
          ...
          <Card className="mb-4 shadow-lg effect-card">
            <Card.Body>
              ...
              >
                ...
                <Card.Text>
                  Quản lý thông tin tài khoản, xem lịch sử giao dịch và cập nhật
                  ảnh đại diện.
                </Card.Text>
              </Link>
            </Card.Body>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p className="text-light">
              Những món đồ tuyệt vời đang chờ đón bạn!
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            ...
            <p className="text-light">
              Đăng ký tham gia và trở thành chủ nhân của những món đồ quý giá!
            </p>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
      ...
      <Carousel>
        ...
        <Carousel.Item>
          <img
            className="d-block w-100"
            src="/anhGD5.jpg"
            alt="Kết thúc đấu giá"
          />
          <Carousel.Caption>
            <h3>Kết thúc đấu giá</h3>
            <p>
              Phiên đấu giá sẽ kết thúc khi đạt mức giá tối đa hoặc hết thời
              gian.
            </p>
          </Carousel.Caption>
        </Carousel.Item>
      ...
      <Row className="text-center">
        {auctions.length > 0 ? (
          auctions.slice(0, 5).map((auction, index) => {
            const isEnded =
              new Date(auction.thoiGianKetThuc) < new Date() ||
              auction.giaChot !== null;
                ...
                <Card className="mb-4 shadow-lg effect-card">
                  ...
                  <Card.Body>
                    ...
                    <p>
                      ...
                      {auction.sanPham.giaKhoiDiem.toLocaleString()} đ
                    </p>
                    <p>
